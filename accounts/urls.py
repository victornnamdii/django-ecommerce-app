...
from . import views
from .forms import PwdResetConfirm, PwdResetForm, UserLoginForm
...
urlpatterns = [
    ...
    path(
        "addresses/edit_checkout/<slug:id>/",
        views.edit_address_checkout,
        name="edit_address_checkout",
    ),
    path(
